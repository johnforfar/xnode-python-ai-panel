...
class Generator:
    def __init__(self, model: Model, device: torch.device):
        ...
        try:
            # --- REINSTATE ORIGINAL DTYPE LOGIC ---
            ...
            # --- END REINSTATE ORIGINAL DTYPE LOGIC ---
            ...
            # Pass the determined dtype (not the forced float32)
