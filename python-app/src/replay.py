...
script = [
    ...
    { "speaker": "RealSatoshi", "line": "That's not leadership - it's grift. Dressed in red, white, and bullsh*t. Bitcoin survived Mt. Gox, China bans, and FTX. It'll survive you too."},
    ...
    { "speaker": "RealSatoshi", "line": "Peter doesn't get the tech. Michael doesn't care about the ethos. Trump just wants to trademark the logo."},
    { "speaker": "CryptoKitty", "line": "Satoshi, final question. What do you think about Bitcoin in this cycle?"},
    { "speaker": "RealSatoshi", "line": "This cycle feels like history on loop. FTX was the rehearsal. SBF crashed it in 2022. Mark my word-Saylor will crash it in 2026."},
