...
class Model(*BaseModelClass):
    ...
    def generate_frame(
        ...
        try:
            ...
            # --- ADD THESE LINES ---
            print(f"DEBUG: Before self.backbone call:")
            print(f"DEBUG: h shape: {h.shape}, h dtype: {h.dtype}")
            print(f"DEBUG: input_pos shape: {input_pos.shape}, input_pos dtype: {input_pos.dtype}")
            print(f"DEBUG: curr_backbone_mask shape: {curr_backbone_mask.shape}, curr_backbone_mask dtype: {curr_backbone_mask.dtype}")
            # --- END ADDED LINES ---
